...
class ProductPageButtons extends Component {
    ...
    componentDidMount() {
        this.setState({
            cartBtn: document.querySelector(
                `.ProductPage-cart-btn-${this.props.productId}[data-product-id='${this.props.productId}']`
            ),
        });
    }
        ...
        return (
            <div class="btn-group" role="group" aria-label="product quantity">
                    ...
                    onClick={() => {
                        this.setState((state, props) => {
                            if (downBtnEnabled(state)) {
                                return {
                                    buttonQuantity: state.buttonQuantity - 1,
                                };
                            }
                        });
                    }}
                ...
                <div
                    className={
                        downBtnEnabled(this.state) ||
                        upBtnEnabled(this.state, this.props)
